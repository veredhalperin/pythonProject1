...
logging.basicConfig(filename='/data/home/vhalpern/pythonProject1/TEST_TRAIN0/beast_network_cluster1.log', level=logging.DEBUG)
import pandas as pd
...
if __name__ == '__main__':
   ...
   #"""
    ...
    with torch.no_grad():
        ...
        pd.read_csv('/data/home/vhalpern/pythonProject1/TEST_TRAIN0/c13k_selections_clusters.csv').merge(df2[['BEASTNET','Problem']],on='Problem').to_csv('/data/home/vhalpern/pythonProject1/TEST_TRAIN0/c13k_selections_cluster1.csv',index=False)
