...
logging.basicConfig(filename='/data/home/vhalpern/pythonProject1/TEST_TRAIN/beast_network_non_dom.log', level=logging.DEBUG)
import pandas as pd
...
if __name__ == '__main__':
   ...
   """
    ...
    with torch.no_grad():
        ...
        pd.read_csv('c13k_selections.csv').merge(df2[['BEASTNET','Problem']],on='Problem').to_csv('TEST_TRAIN/c13k_selections_non_dom.csv',index=False)
