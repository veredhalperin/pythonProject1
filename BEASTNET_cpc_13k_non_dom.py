...
if __name__ == '__main__':
    ...
    """
    trainBEASTNet(nLastFile=270, pklName='RealData270', csvName='RealData270_non_dom', csvNameFinal='RealData270_cpc_13k_non_dom', logName='RealData270_cpc_13k_non_dom',
               probs0=[ 1.7617,1.6392,-0.2787,1.8778], probs1=[2.7155,1.5172,-0.0474,1.5147], probs2=[2.8417,1.4882,-0.0068,1.4768],
               probs3=[2.9667,1.4582,0.0349,1.4402], probs4=[3.0899,1.4278,0.0772,1.4050], BEV=0.176349999999999 , b=0.367309999999999)
    """
