...
logging.basicConfig(filename='/data/home/vhalpern/pythonProject1/TEST_TRAIN9/beast_network_cluster2.log', level=logging.DEBUG)
import pandas as pd
...
if __name__ == '__main__':
   ...
   #"""
    ...
    df=pd.read_csv('/data/home/vhalpern/pythonProject1/TEST_TRAIN9/c13k_selections_clusters.csv')
    df = df[df['cluster'] == 2]
    ...
    with torch.no_grad():
        ...
        pd.read_csv('/data/home/vhalpern/pythonProject1/TEST_TRAIN9/c13k_selections_clusters.csv').merge(df2[['BEASTNET','Problem']],on='Problem').to_csv('/data/home/vhalpern/pythonProject1/TEST_TRAIN9/c13k_selections_cluster2.csv',index=False)
